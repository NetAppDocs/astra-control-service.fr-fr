...
* Si vous utilisez ou prévoyez d'utiliser un système de stockage NetApp, assurez-vous d'avoir installé une version d'Astra Trident link:../get-started/requirements.html#operational-environment-requirements["Pris en charge par le service Astra Control"^]:
+
