...
* https://["Documentation Azure pour clusters AKS privés"^]
* https://["Documentation Azure pour les clusters OpenShift privés"^]
...
----
. Générez un jeton API de contrôle Astra en suivant les instructions de la section https://["Documentation relative à l'automatisation d'Astra"^].
...
* https://["Configuration de Microsoft Azure avec Azure NetApp Files"]
* https://["Configuration de Microsoft Azure avec des disques gérés Azure"]
...
Vous pouvez maintenant ajouter le cluster privé à Astra Control Service. Suivez le workflow standard pour ajouter un cluster au service Astra Control : https://["Commencez à gérer les clusters Kubernetes à partir d'Astra Control Service"].
