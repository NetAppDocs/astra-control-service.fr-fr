...
Pour utiliser des disques gérés Azure avec Astra Control Service, vous devez d'abord configurer la fonctionnalité de snapshot de volume CSI pour les versions Kubernetes antérieures à 1.21 et installer également les pilotes CSI requis.



=== Installation d'un contrôleur de snapshot de volume CSI pour Kubernetes 1.19

Si vous utilisez Kubernetes version 1.19, suivez ces instructions pour installer un contrôleur de snapshot de volume.
...
=== Installation d'un contrôleur de snapshot de volume CSI pour Kubernetes 1.20

Si vous utilisez Kubernetes version 1.20, suivez ces instructions pour installer un contrôleur de snapshot de volume.
