...
| Quelles sont les fonctionnalités de gestion des données applicatives ? | Mêmes fonctionnalités sur les deux plateformes, sans exception au système de stockage back-end ou aux services externes (voir <<Caractéristiques>>)  a| 
Mêmes fonctionnalités sur les deux plateformes, sans exception au système de stockage back-end ou aux services externes (voir <<Caractéristiques>>)
