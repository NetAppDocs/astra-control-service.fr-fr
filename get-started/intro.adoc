...
+ ** pour les clusters GKE, Astra Control Service utilise https://["NetApp Cloud Volumes Service pour Google Cloud"^] Ou des disques persistants Google en tant que système de stockage back-end pour vos volumes persistants.

endif::gcp[]

ifdef::azure[]

+ ** pour les grappes AKS, Astra Control Service utilise https://["Azure NetApp Files"^] Ou des disques gérés Azure en tant que backend de stockage pour les volumes persistants.

endif::azure[]

ifdef::aws[]

+ ** pour les clusters Amazon EKS, Astra Control Service utilise https://["Amazon Elastic Block Store"^] ou https://["Amazon FSX pour NetApp ONTAP"^] en tant que système back-end de stockage pour vos volumes persistants.
...
* Utilise ce nouveau rôle d'administrateur pour l'installation https://["Astra Trident"^] sur le cluster et pour créer une ou plusieurs classes de stockage.
...
Pour installer et utiliser Astra Control Center, vous devez vous en assurer https://["de formation"].

À un niveau élevé, le centre de contrôle Astra ressemble à ce qui suit :

* Vous installez Astra Control Center dans votre environnement local. En savoir plus https://["Poser le centre de contrôle Astra"].
...
En savoir plus https://["Configurer le centre de contrôle Astra"].
...
* https://["Documentation relative à la gamme de produits NetApp Astra"^]
