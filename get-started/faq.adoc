...
*J'ai mis à niveau le Plan Premium PayGo à partir du Plan gratuit. Serai-je chargé pour les 10 premières applications?*

Oui. Après la mise à niveau vers le plan Premium, Astra Control commence à vous charger pour toutes les applications gérées de votre compte.
...
* Vérifiez que le type d'image du nœud de travail est Ubuntu et que le montage NFS a réussi.
