...
Vous pouvez ajouter une nouvelle instance de Cloud lorsque vous ajoutez un nouveau cluster à Astra Control. Reportez-vous à la section link:../add-first-cluster.html["Commencez à gérer les clusters Kubernetes à partir d'Astra Control Service"] pour en savoir plus.
