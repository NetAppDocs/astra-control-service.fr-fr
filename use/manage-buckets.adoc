...
* *Nom du serveur S3 ou adresse IP* (types de compartiment AWS et S3 uniquement) : entrez le nom de domaine complet du terminal S3 correspondant à votre région, sans `https://`. Reportez-vous à la section https://["La documentation Amazon"^] pour en savoir plus.
