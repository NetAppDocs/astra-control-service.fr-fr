...
* https://["Consultez les détails de tarification pour Cloud Volumes Service"^].
+
Notez que le service Astra Control prend en charge tous les types de service et tous les niveaux de service. Le type de service que vous utilisez dépend de votre https://["Région Google Cloud"^].

* https://["Consultez les détails des prix des compartiments de stockage Google Cloud"^].
...
* https://["Consultez les détails de tarification pour Azure NetApp Files"^].
* https://["Consultez les détails des prix du stockage Microsoft Azure Blob"^].
...
* https://["Voir les détails de tarification pour Amazon Web Services"^].
...
NOTE: Pour visionner une vidéo de présentation du processus d'abonnement à Azure Marketplace, rendez-vous sur https://["NetApp TV"^].

.Étapes
. Accédez au https://["Azure Marketplace"^].
...
.Étapes
. Accédez au https://["AWS Marketplace"^].
