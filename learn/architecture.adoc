...
image:astra-architecture-diagram-v5.png["Schéma d'architecture et composants d'Astra Control"]
...
+
** Utilisation d'Astra Control Service https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Files"^], Disques gérés Azure, et https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] En tant que système back-end de stockage pour les clusters AKS.
** Utilisation d'Astra Control Service https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service pour Google Cloud"^], Google persistent Disk, et https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] En tant que système back-end de stockage pour les clusters GKE.
** Utilisation d'Astra Control Service https://docs.aws.amazon.com/ebs/["Amazon Elastic Block Store"^] et https://docs.aws.amazon.com/fsx/["Amazon FSX pour NetApp ONTAP"^] En tant que système back-end de stockage pour les clusters AWS.
