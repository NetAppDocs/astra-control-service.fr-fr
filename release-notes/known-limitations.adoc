...
Astra Control Service prend en charge un projet Google Cloud Platform et un compte de service. Vous ne devez pas ajouter plus d'un compte de service au service Astra Control et vous ne devez pas faire pivoter les identifiants de compte de service.
