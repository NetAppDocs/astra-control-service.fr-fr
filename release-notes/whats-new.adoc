...
* Prise en charge de NetApp Cloud Volumes ONTAP en tant que système back-end de stockage (officiellement pris en charge sur Microsoft Azure et Google Cloud Platform)
+
link:../learn/architecture.html#astra-control-components["Architecture et composants"]
